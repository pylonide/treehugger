...
module.exports = {
    ...
    "test es7": function() {
        // await y() was not parsed correctly, needs further investigation if required to be parsed correctly
        assert.equal(parser.parse("async function a(x) { y()} ").toString(), '[Function("a",[FArg("x")],[Call(Var("y"),[])])]');
    }
};
